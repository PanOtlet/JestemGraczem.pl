...
urlpatterns = [
    ...
    path('youtube/<int:page>/', cache_page(60 * 1)(views.youtube), name='youtube'),
    path('youtube/player/<str:videoid>/', cache_page(60 * 1)(views.youtube_player), name='youtube.video'),
